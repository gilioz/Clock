...
#define LEDCLOCK_COUNT 224
#define LEDDOWNLIGHT_COUNT 14

  //(red * 65536) + (green * 256) + blue ->for 32-bit merged colour value so 16777215 equals white
  //blue color: 3355647
int clockMinuteColour = 357169; //1677 
int clockHourColour = 25298; //7712
...
void loop() {
  ...
  stripClock.show();
   ...
   //(red * 65536) + (green * 256) + blue ->for 32-bit merged colour value so 16777215 equals white
  stripDownlighter.fill(15787660, 0, LEDDOWNLIGHT_COUNT);
